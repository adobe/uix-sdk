    ...
    const extensionUrls: string[] = Object.keys(extUrlParams)
        .filter(
            (extParam) =>
                ...
                extParam === `${EXT_PARAM_PREFIX}.${extensionPointId.service}/${extensionPointId.name}/${extensionPointId.version}`
        )
    ...
    const installedExtensions: InstalledExtensions = extensionUrls
        .map((extensionUrl: string) => {
            return {
                ...
                url: extensionUrl,
                extensionPoints: [`${extensionPointId.service}/${extensionPointId.name}/${extensionPointId.version}`],
            } as Extension;
        })
